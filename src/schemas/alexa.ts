...
export const SetVolumeSchema = z.object({
  deviceType: z
    .string()
    .optional()
    .describe('Device type (optional - if you have only one device, it will be auto-detected)'),
  dsn: z
    .string()
    .optional()
    .describe(
      'Device serial number (optional - if you have only one device, it will be auto-detected)',
    ),
